...
namespace Core
{
    public class ObjectPooler
    {
        ...
        private void InitializePool(int poolCount, float distanceBetweenObstacles, List<GameObject> pooledObject, Transform parentTransform)
        {
            ...
            for (int i = 0; i < poolCount; i++)
            {
                ...
                if (i < pooledObject.Count)
                    ...
                    obj = Object.Instantiate(pooledObject[pooledObject.Count - 1], parentTransform);
        ...
        /// <param name="parentTransform"></param>
        /// <returns></returns>
        public GameObject GetPooledGameObject(List<GameObject> pooledObject, float distanceBetweenObstacles, int poolCount, Transform parentTransform)
        {
            ...
            randomIndex = Random.Range(0, pooledObject.Count);
